...
[BackupType] [nvarchar] (4) NOT NULL,
[BackupFile] [nvarchar] (500) NOT NULL,
[HistoryFile] [nvarchar] (500) NULL
)
...
BEGIN
	...
	FROM @affected aff
		INNER JOIN Backups baks
				...
				INNER JOIN dbo.UDF_SplitString('%icomcept', ',') exc
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE USP_KillProcesses 
	@dbName		NVARCHAR(500)
AS
BEGIN
...
BEGIN
	...
	IF EXISTS(	SELECT 1
				FROM #output 
				WHERE contents = 'The system cannot find the file specified.' 
					OR contents = 'The system cannot find the path specified.'
					OR contents = 'File Not Found' ) SET @exist = 0
...
-- Description:	<Description, ,>
-- =============================================
CREATE FUNCTION UDF_GetFileName
(
	@path	NVARCHAR(4000)
)
RETURNS NVARCHAR(4000)
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE USP_CloneDatabase 
