...
GO
PRINT N'Creating primary key [PK_Settings] on [dbo].[Settings]'
GO
ALTER TABLE [dbo].[Settings] ADD CONSTRAINT [PK_Settings] PRIMARY KEY CLUSTERED  ([Key])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetBackupFolder]'
GO
-- =============================================
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetBackupFolder] 
(
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_SplitString]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetAffectedDatabases]'
GO
...
-- =========================================================================
CREATE FUNCTION [dbo].[UDF_GetAffectedDatabases] 
(	
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetCloneFolder]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetCloneFolder] 
(
)
RETURNS NVARCHAR(256)
AS
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[Backups]'
GO
CREATE TABLE [dbo].[Backups]
(
[BackupID] [int] NOT NULL IDENTITY(1, 1),
[DatabaseName] [nvarchar] (250) COLLATE Latin1_General_CI_AS NOT NULL,
[DatabaseID] [int] NOT NULL,
[TimeStamp] [datetime] NOT NULL,
[BackupType] [nvarchar] (4) COLLATE Latin1_General_CI_AS NOT NULL,
[BackupFile] [nvarchar] (500) COLLATE Latin1_General_CI_AS NOT NULL,
[HistoryFile] [nvarchar] (500) COLLATE Latin1_General_CI_AS NULL
)
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating primary key [PK_Backups_1] on [dbo].[Backups]'
GO
ALTER TABLE [dbo].[Backups] ADD CONSTRAINT [PK_Backups_1] PRIMARY KEY CLUSTERED  ([BackupID])
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetBackupFile]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetBackupFile]
(
	@dbName	NVARCHAR(100),
	@dbID	INT
)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetAffectedBackups]'
GO
-- =============================================
-- Author:		Thomas Stensitzki	
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetAffectedBackups] 
(	
	@includeDbName		NVARCHAR(4000) = NULL,
	@excludeDbName		NVARCHAR(4000) = NULL
)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetFolderNameFromShell]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetFolderNameFromShell] 
(
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetFileNameFromShell]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetFileNameFromShell] 
(
	@shellLine NVARCHAR(4000)
)
RETURNS NVARCHAR(4000)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[SPID_GetFolders]'
GO
CREATE TABLE [dbo].[SPID_GetFolders]
(
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_ExistFile]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_ExistFile] 
	@path	NVARCHAR(4000),
	@exist	BIT OUT
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_ExistFolder]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_ExistFolder] 
	@path	NVARCHAR(4000),
	@exist	BIT OUT
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[SPID_GetFiles]'
GO
CREATE TABLE [dbo].[SPID_GetFiles]
(
[SPID] [smallint] NOT NULL,
[Path] [nvarchar] (4000) COLLATE Latin1_General_CI_AS NULL
)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_CreateFolder]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_CreateFolder] 
	@path	NVARCHAR(4000)
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetHistoryFolder]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetHistoryFolder] 
(
	@dbName		NVARCHAR(100) = NULL,
	@dbID		INT = NULL
)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetFileName]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_KillProcesses]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_KillProcesses] 
	@dbName		NVARCHAR(500)
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_CloneDatabase]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_CloneDatabase] 
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[UDF_GetTimeStamp]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE FUNCTION [dbo].[UDF_GetTimeStamp] 
(
	@now	DATETIME
)
RETURNS NVARCHAR(15)
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_GetFolders]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_GetFiles]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_CleanUpHistory_SYNC]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_CleanUpHistory_SYNC]
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_BackupDatabase_FULL]'
GO
CREATE PROCEDURE [dbo].[USP_BackupDatabase_FULL]
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_BackupDatabase_DIFF]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_BackupDatabase_DIFF] 
	@includeDbName	NVARCHAR(256) = NULL,
	@excludeDbName	NVARCHAR(256) = NULL
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_BackupDatabase_TRAN]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_BackupDatabase_TRAN] 
	@includeDbName	NVARCHAR(256) = NULL,
	@excludeDbName	NVARCHAR(256) = NULL
AS
BEGIN
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_BackupDatabase]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_CleanUpHistory]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
...
-- =============================================
CREATE PROCEDURE [dbo].[USP_CleanUpHistory]
	@maxGeneration	INT = 0,
	@maxAgeAsDays	INT = 0,
	@includeDbName	NVARCHAR(256) = NULL,
	@excludeDbName	NVARCHAR(256) = NULL
...
IF @@TRANCOUNT=0 BEGIN INSERT INTO #tmpErrors (Error) SELECT 1 BEGIN TRANSACTION END
GO
PRINT N'Creating [dbo].[USP_ExecDBCC]'
GO
-- =============================================
-- Author:		Thomas Stensitzki
-- Create date: 2008-10-20
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[USP_ExecDBCC]
